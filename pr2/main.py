...
def test_single_cube(verbose = True):
  ...
  pathlength, success = searchBasedPlan(start, goal,'./maps/single_cube.txt', 1, 10000, 1)
...
def test_maze(verbose = True):
  ...
  pathlength, success = searchBasedPlan(start, goal,'./maps/maze.txt', 0.8, 10000, 1)
  print('Success: %r'%success)
  print('Path length: %f'%pathlength)
  print('\n')
...
def test_window(verbose = True):
  ...
  pathlength, success = searchBasedPlan(start, goal,'./maps/window.txt', 1, 10000, 1)
  print('Success: %r'%success)
  print('Path length: %f'%pathlength)
  print('\n')
...
def test_tower(verbose = True):
  ...
  pathlength, success = searchBasedPlan(start, goal,'./maps/tower.txt', 1, 10000, 1)
  print('Success: %r'%success)
  print('Path length: %f'%pathlength)
  print('\n')
...
def test_flappy_bird(verbose = True):
  ...
  pathlength, success = searchBasedPlan(start, goal,'./maps/flappy_bird.txt', 1, 10000, 1)
  print('Success: %r'%success)
  print('Path length: %f'%pathlength)
  print('\n')
...
def test_room(verbose = True):
  ...
  pathlength, success = searchBasedPlan(start, goal,'./maps/room.txt', 1.5, 10000, 1)
  print('Success: %r'%success)
  print('Path length: %f'%pathlength)
  print('\n')
...
def test_monza(verbose = True):
  ...
  pathlength, success = searchBasedPlan(start, goal,'./maps/monza.txt', 1.5, 10000, 1)
  print('Success: %r'%success)
  print('Path length: %f'%pathlength)
  print('\n')
