...
DOOR_1_POS = np.array([4,2], dtype=np.int16) + np.array([1,1])
DOOR_2_POS = np.array([4,5], dtype=np.int16) + np.array([1,1])
...
def calculateSingleOptimalPolicy(randomMap, initialStates, timeHorizon):
